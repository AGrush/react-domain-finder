...
describe('Wallet', () => {
  ...
  describe('when the user types into the wallet input', () => {
    ...
    it('updates the local balance in `state` and it converts it to a number', () => {
      expect(wallet.state().balance).toEqual(parseInt(userBalance))
    })

    describe('and the user whants to make a deposit', () => {
    ...
    describe('and the user whants to make a withdraw', () => {
